...
ggsave(filename = "C:/Users/DePrengm/OneDrive - Denver Botanic Gardens/P drive/My Documents/UCDenver_phd/Dissertation/Chapter3/Figures/Virtualextinctionmetrics.jpg",
       stochLam / (ERplot + time2extplot) +plot_layout(widths = c(2,1)),
...
simgenlengthEmp1 <- ggplot(toplotEmp1[toplotEmp1$StPopSz == 500 & toplotEmp1$SimLengthtext == "3 generations",], 
...
simgenlength2 <- ggplot(toplotEmp1[toplotEmp1$StPopSz == 500 & toplotEmp1$SimLengthtext == "3 generations",], 
...
# extinction risk
toplotextinctionrisk <- as.data.frame(table(ER = toplotEmp1$Exterpated, 
                                            SimLength = toplotEmp1$SimLengthtext, 
                                            MatrixType = toplotEmp1$MatrixType, 
...
# time to extinction
 ggplot(toplotEmp1, aes(SimLengthtext, Time2Ext, colour = as.factor(StPopSz)))+
  # geom_jitter(height = 0, width = 2, alpha = 0.4, shape = 20)+
  # geom_boxplot(x = as.factor(toplotEmp1$generationtime[toplotEmp1$StPopSz == 500]))+
  geom_boxplot()+
  theme_bw()+
  ylab("Time to extinction" )+ 
  # theme(axis.text.x = element_text(angle = 90))+
...
# Alternative time to extinction
time2extplot <- ggplot(toplotEmp1, aes(MatrixType, Time2Ext, colour = SimLengthtext))+
  geom_boxplot()+
  theme_bw()+
  scale_colour_manual(name = "Simulation length",
                      values = c("orange","grey","blue"),
