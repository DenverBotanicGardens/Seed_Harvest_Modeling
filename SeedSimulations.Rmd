...
# TMx_all[grep("NEMA", unlist(Nx_names))][1] %*% Nx_all[grep("NEMA", unlist(Nx_names))][1]
...
sp_info[sp_info$SPP == "NEMA",]
Nx_names[grep("NEMA", Nx_names)]
...
lapply(unique(tm$SPP)[-2], function(sp){
    ...
    # avgInt <- lapply(0, function(avgInt){
      outdf <- do.call(rbind,lapply(1:100, function(rep){
        outSimulation <- SeedHarvestSim(Mx_list = Mx_all[grep(sp, unlist(Nx_names))], 
                                        ...
                                        ddceiling = FALSE)
        save(outSimulation, file = paste(pathstart,"NoHarvest_",sp,"PopSz",popsz,"Rep",rep,".Rdata", sep="")) #"AvgInt",avgInt,"Freq",FrG,"
  ...
  # bypopsz
  save(bypopsz, file = paste(pathstart, "NoHarvest",sp,".Rdata", sep=""))
  }) # end species
