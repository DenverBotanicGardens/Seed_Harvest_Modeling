...
# toplot <- do.call(rbind, list(toplot100yrs,toplot3gen,toplot10yrs))
table(toplot$SimLength) 
table(toplot$SimLengthtext)
table(toplot$MatrixType)
# toplot <- toplot[toplot$MatrixType != "",]
...
```{r}
pathstartVirtual3gen # "None
pathstartVirtual10yrs # "None"
...
simgenlengthEmp1 <- ggplot(toplotEmp1[toplotEmp1$StPopSz == 500 & toplotEmp1$SimLengthtext == "3 generations",], 
       aes(MatrixType, generationtime*3))+ # , colour = MatrixType))+
  geom_boxplot()+
  theme_bw()+
  ylab("Simulation length\n years")+
  scale_x_discrete(labels = c("Annual" = "Annual",
