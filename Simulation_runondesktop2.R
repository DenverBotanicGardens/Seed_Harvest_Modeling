...
SimSimpleVirtual(HarvestType = "NoneVirtual100", MatrixType = "SemelFast", Mxs = Tmx_semelfast,
...
SimSimpleVirtual(HarvestType = "NoneVirtual100", MatrixType = "SemelSlow", Mxs = Tmx_semelslow,
                 Nxs = Nxs_othertypes, Simlength = 100, generationspan = FALSE, 
                 stablestagestart = TRUE, ps = pathstartVirtual)


SimSimpleVirtual(HarvestType = "NoneVirtual100", MatrixType = "IteroSlow", Mxs = Tmx_iteroslow,
                 Nxs = Nxs_othertypes, Simlength = 100, generationspan = FALSE, 
                 stablestagestart = TRUE, ps = pathstartVirtual)
