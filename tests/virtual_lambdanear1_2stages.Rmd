...
MPM_itero <- function(params, stage1, stage2){
  ...
  (G2 <- Growth(alpha2 = params[i,1], beta2 = params[i,2],Age_1 = stage2+(stage2 - stage1), Age_2 = stage2+(stage2 - stage1)*2))
...
# ------------------ Iteroparous fast ------------------------
# get 100 runs
itfast <- lapply(1:100, function(x) MPM_itero(params8, stage1 = stage1, stage2 = stage2))
...
params8slow <- params8slow[params8slow$a2b2 %in%
                    params8slow$a2b2[params8slow$survival < 0.779 & params8slow$age == stage2],]
params8slow <- params8slow[params8slow$a2b2 %in%
                    params8slow$a2b2[params8slow$survival > 0.75 & params8slow$age == stage2],]
