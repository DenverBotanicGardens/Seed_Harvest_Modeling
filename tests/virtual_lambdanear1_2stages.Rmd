...
layout(matrix(c(1,1,2,1,1,3),ncol=3, byrow = TRUE), width = c(2,2,1),height = c(1,1))
par(mar = c(0,0,0,0))
        Ternary::TernaryPlot(point = "up",
                             atip = "G",
                             btip = "S",
...
sefast <- lapply(1:100, function(x){ 
  stage1 <- max(1,rpois(1,1))
  stage2 <- stage1+1
  MPM_semel(paramsAll, stage1 = stage1, stage2 = stage2, maxSurv = 0.42, minSurv = 0.02) # because want really low survival to drive up fecudity
  })
