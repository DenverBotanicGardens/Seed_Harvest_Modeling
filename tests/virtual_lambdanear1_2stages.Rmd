...
itslow <- lapply(1:100, function(x){ 
  ...
  MPM_itero(paramsAll, stage1 = stage1, stage2 = stage2, 
            ...
            maxSurvVeg = 0.87, maxSurvRep = 0.8,minSurv = 0.11)
  })
...
sefast <- lapply(1:100, function(x){ 
  ...
  stage2 <- stage1+1
  MPM_semel(paramsAll, stage1 = stage1, stage2 = stage2, maxSurv = 0.3, minSurv = 0.01) # because want really low survival to drive up fecudity
  })
