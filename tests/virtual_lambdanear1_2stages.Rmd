...
MPM_itero <- function(params, stage1, stage2, maxSurv = 0.8, minSurv = 0.001){
  ...
  # possibleParams <- possibleParams[possibleParams$survival < maxSurv & possibleParams$age == 1,]
  G_all <- sapply(1:nrow(possibleParams),function(x){
    Growth(alpha2 = possibleParams[x,1], beta2 = possibleParams[x,2], Age_first_1 = 1, Age_first_2 = stage1+1)
    })
  if(stage1 > 1){
  ...
  # params1 <-  params[params$survival < 0.8 & params$survival > 0.2 & params$age == stage1+1 &
  #                            !is.na(params$survival),]
...
itfast <- lapply(1:100, function(x){ 
  ...
  MPM_itero(paramsAll, stage1 = stage1, stage2 = stage2, maxSurv = 0.6, minSurv = 0.01)
  })
