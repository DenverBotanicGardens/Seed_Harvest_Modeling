...
plot(0:15, survivalTypeI(params_itero_fast[1,1], params_itero_fast[1,2], 0:15), type = "l", col = rainbow(nrow(params_itero_fast), alpha = 1)[1],
     ...
     ylim = c(0,1))
for(i in 2:nrow(params_itero_fast)){
  lines(0:15, survivalTypeI(params_itero_fast[i,1], params_itero_fast[i,2], 0:15), type = "l", col = rainbow(nrow(params_itero_fast), alpha = 0.5)[i])
  abline(v = 1)
  abline(v = mean())
}
...
plot(0:15, survivalTypeI(params_semel_fast[1,1], params_semel_fast[1,2], 0:15), type = "l", col = rainbow(nrow(params_semel_fast), alpha = 1)[1],
     ...
     ylim = c(0,1))
for(i in 2:nrow(params_semel_fast)){
