...
Stasis <- function(Age_last_1, alpha2, beta2){
  survivalTypeI(alpha2, beta2, Age_last_1)/sum(survivalTypeI(alpha2, beta2, 1:Age_last_1))
}
...
if(stage1 > 1){
  S_all <- sapply(1:nrow(possibleParams),function(x){
    Stasis(alpha2 = possibleParams[x,1], beta2 = possibleParams[x,2], Age_last_1 = stage1)
  })
} else {
    S_all <- sapply(1:nrow(possibleParams),function(x){
...
MPM_itero <- function(params, stage1, stage2){
  ...
  params1 <- possibleParams[(S_all + G_all) < 0.99,]
  i <- sample(1:nrow(params1),1)
  (s_s <- survivalTypeI(alpha2 = params1[i,1], beta2 = params1[i,2], c(stage1,stage2)))
