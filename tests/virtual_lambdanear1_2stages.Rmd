...
params_semel <- params[params$a2b2 %in%
                      params$a2b2[params$survival < .99 & params$age == 2],]

params_semel <- params_semel[params_semel$a2b2 %in%
                               params_semel$a2b2[params_semel$survival < 0.8 &
                                                   params_semel$survival > 0.5 &
                                                   params_semel$age == 4],]
params_semel <- params_semel[params_semel$a2b2 %in%
                               params_semel$a2b2[params_semel$survival < 0.4 & params_semel$age == 5],]

# params_semel <- params_semel[params_semel$a2b2 %in%
#                                params_semel$a2b2[params_semel$survival > 0 &
#                                                    params_semel$survival < 0.05 & params_semel$age == 26],]
