...
params8 <- params8[params8$a2b2 %in% 
                    params8$a2b2[ params8$survival > 0.4 & params8$survival < 0.8 & params8$age == stage2],] 
params8 <- params8[params8$a2b2 %in% 
                    params8$a2b2[  params8$survival > 0.2 & params8$survival < 0.3 & params8$age == stage2+(stage2-stage1)],]
...
MPM_iterofast <- function(){
  ...
  (G <- Growth(alpha2 = params8[i,1], beta2 = params8[i,2],Age_1 = stage1, Age_2 = stage2))
...
MPM_iteroslow <- function(){
  # three juvenile stages, one reproductive
  i <- sample(1:nrow(params8slow),1)
  (s_s <- survivalTypeI(alpha2 = params8slow[i,1],beta2 = params8slow[i,2], c(stage1, stage2)))
  (f <- itero_fecundsurv(s_s[2]))
  # transitions or growth based on how far away (how big a reduction along survival curve) to get from stage 1 to 2
  (G <- Growth(alpha2 = params8slow[i,1], beta2 = params8slow[i,2],Age_1 = stage1, Age_2 = stage2))
  # Of the ones that survive, s_s[1], what proportion grow? 
  t_ij <- matrix(c(s_s[1]-G, G,
                   f, s_s[2]),
                 nrow = 2)
