...
itfast <- lapply(1:100, function(x){ 
  ...
  MPM_itero(paramsAll, stage1 = stage1, stage2 = stage2, maxSurv = 0.005, minSurv = 0.0001) 
  })
...
itslow <- lapply(1:100, function(x){ 
  ...
  MPM_itero(paramsAll, stage1 = stage1, stage2 = stage2, maxSurv = 0.5,minSurv = 0.3) # maxSurv = 0.42,minSurv = 0.25)
  })
...
seslow <- lapply(1:100, function(x){ 
  ...
  stage2 <- stage1+1
  MPM_semel(paramsAll, stage1 = stage1, stage2 = stage2, maxSurv = 0.26, minSurv = 0.09)
  })
