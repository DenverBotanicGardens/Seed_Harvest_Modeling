...
#                       params$a2b2[params$survival < .99 & params$survival > 0.001 & params$age == 3],]
# 
# params_semel <- params_semel[params_semel$a2b2 %in% 
#                                params_semel$a2b2[params_semel$survival < 0.8 &
#                                                    params_semel$survival > 0.68 & params_semel$age == 4],]
# # params_semel <- params_semel[params_semel$a2b2 %in% 
# #                                params_semel$a2b2[params_semel$survival < 0.35 & params_semel$age == 4],]
# 
# params_semel <- params_semel[params_semel$a2b2 %in%
#                                params_semel$a2b2[params_semel$survival < 0.03 &
#                                                    params_semel$survival > 0 & params_semel$age == 14],]
...
plot(0:11, survivalTypeI(params_semel[1,1], params_semel[1,2], 0:11), type = "l", 
     ...
     ylim = c(0,1))
for(i in 2:nrow(params8)){
  lines(0:11, survivalTypeI(params_semel[i,1], params_semel[i,2], 0:11), type = "l", 
...
sefast <- lapply(1:100, function(x){ 
  ...
  stage2 <- stage1 + max(1,rpois(1,2))
  MPM_semel(params_semel, stage1 = stage1, stage2 = stage2)
  })
...
#### Iteroparous ---------------------------------
par(mar = c(2,4,2,0))
plot(0:11, survivalTypeI(params_itero[1,1], params_itero[1,2], 0:11), type = "l", col = rainbow(nrow(params_itero), alpha = 1)[1],
     # xlab = "",xaxt = "n",
     xlab = "Age in years",
     ylab = "Survival (stasis)",
     ylim = c(0,1))
for(i in 2:nrow(params_itero)){
  lines(0:11, survivalTypeI(params_itero[i,1], params_itero[i,2], 0:11), type = "l", col = rainbow(nrow(params_itero), alpha = 1)[i])
}
mtext("a) iteroparous", adj=0)

#### semelparous ---------------------------------
par(mar = c(2,2,2,1))
plot(0:11, survivalTypeI(params_semel[1,1], params_semel[1,2], 0:11), type = "l", col = rainbow(nrow(params_semel), alpha = 1)[1],
