...
#   (G2 <- Growth(alpha2 = params8[i,1], beta2 = params8[i,2],Age_1 = stage2+(stage2 - stage1), Age_2 = stage2+(stage2 - stage1)*2))
#   # Of the ones that survive, s_s[1], what proportion grow? 
#   t_ij <- matrix(c(s_s[1]-G, G,
#                    f, s_s[2]-G2),
#                  nrow = 2)
...
params8slow <- params8slow[params8slow$a2b2 %in%
                    params8slow$a2b2[params8slow$survival > 0.7 & params8slow$age == stage2],]
