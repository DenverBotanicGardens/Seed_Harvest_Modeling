...
IPM_basic <- function(df, minsize, maxsize, bin.num, seedlings_per_seed, allsdszs, surv_seedlings, seeds_per_flower){
    # Empty list items
...
scgl_IPM_all <- IPM_basic(df = size_scgl, minsize = minsize_scgl, maxsize = maxsize_scgl, seedlings_per_seed = seedlings_per_seed_sg, bin.num = testbins, allsdszs = allsdszs_scgl, surv_seedlings = surv_minis, seeds_per_flower = 150)

scgl_IPM_all


scgl_IPM_NS <- lapply(unique(size_scgl$Region), function(x){
  IPM_basic(df = size_scgl[size_scgl$Region == x,], minsize = minsize_scgl, maxsize = maxsize_scgl, seedlings_per_seed = seedlings_per_seed_sg, bin.num = testbins, allsdszs = allsdszs_scgl, surv_seedlings = surv_minis, seeds_per_flower = 150)
  })

IPM_basic(df = size_scgl[size_scgl$Region == "South",], minsize = minsize_scgl, maxsize = maxsize_scgl, seedlings_per_seed = seedlings_per_seed_sg, bin.num = testbins, allsdszs = allsdszs_scgl, surv_seedlings = surv_minis, seeds_per_flower = 150)

scgl_IPM_sites <- lapply(unique(size_scgl$Site), function(x){
  IPM_basic(df = size_scgl[size_scgl$Site == x,], minsize = minsize_scgl, maxsize = maxsize_scgl, seedlings_per_seed = seedlings_per_seed_sg, bin.num = testbins, allsdszs = allsdszs_scgl, surv_seedlings = surv_minis, seeds_per_flower = 150)
})

size_scgl[size_scgl$Site == "Escalante Canyon",]

# Errors
IPM_basic(df = size_scgl[size_scgl$Site ==  "Escalante Canyon",], minsize = minsize_scgl, maxsize = maxsize_scgl, seedlings_per_seed = seedlings_per_seed_sg, bin.num = testbins, allsdszs = allsdszs_scgl, surv_seedlings = surv_minis, seeds_per_flower = 150)

# Works
sc_Atwell <- IPM_basic(df = size_scgl[size_scgl$Site ==  "Atwell Gulch",], minsize = minsize_scgl, maxsize = maxsize_scgl, seedlings_per_seed = seedlings_per_seed_sg, bin.num = testbins, allsdszs = allsdszs_scgl, surv_seedlings = surv_minis, seeds_per_flower = 150)

# Nope
sc_Bridgeport <- IPM_basic(df = size_scgl[size_scgl$Site ==  "Bridgeport",], minsize = minsize_scgl, maxsize = maxsize_scgl, seedlings_per_seed = seedlings_per_seed_sg, bin.num = testbins, allsdszs = allsdszs_scgl, surv_seedlings = surv_minis, seeds_per_flower = 150)

sc_OilPad <- IPM_basic(df = size_scgl[size_scgl$Site ==  "Oil Pad",], minsize = minsize_scgl, maxsize = maxsize_scgl, seedlings_per_seed = seedlings_per_seed_sg, bin.num = testbins, allsdszs = allsdszs_scgl, surv_seedlings = surv_minis, seeds_per_flower = 150)

sc_PyramidRock <- IPM_basic(df = size_scgl[size_scgl$Site ==  "Pyramid Rock",], minsize = minsize_scgl, maxsize = maxsize_scgl, seedlings_per_seed = seedlings_per_seed_sg, bin.num = testbins, allsdszs = allsdszs_scgl, surv_seedlings = surv_minis, seeds_per_flower = 150)
```
