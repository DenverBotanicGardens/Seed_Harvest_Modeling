...
glm1 <- glm(survival ~ t0, family = "binomial", data = size_scgl1) # survival depending on size
glm2 <- glm(survival ~ t0 + t0sq, family = "binomial", data = size_scgl1) # survival depending on size squared (curve)
...
Model comparing all the climate drivers
