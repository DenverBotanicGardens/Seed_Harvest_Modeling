...
for(sp in unique(tm$SPP)){
      ...
      # time2ext.df$Harvest <- paste(time2ext.df$GoodInt, time2ext.df$BadInt, sep=":")
      ...
      ggsave(filename = paste("C:/Users/DePrengm/Denver Botanic Gardens/Conservation - Demography/SeedHarvestModelling/Seed_Harvest_Modeling/",sp,"_time2ext.jpg",sep=""),
             ggplot(time2ext.df, aes(Harvest, Years, colour = Harvest))+
               geom_boxplot()+
               # theme(legend.position="none")+
               theme_bw()+
               theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))#+
               # facet_wrap(~GoodFreq+BadFreq)
               ,
