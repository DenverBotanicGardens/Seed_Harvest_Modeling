...
# Works
IPM_basic(df = size_scgl[size_scgl$Site ==  "Escalante Canyon",], seedlings_per_seed = seedlings_per_seed_sg, bin.num = testbins,  seedling_size = 0.5, surv_seedlings = surv_minis, seeds_per_flower = 150)

# Works
sc_Atwell <- IPM_basic(df = size_scgl[size_scgl$Site ==  "Atwell Gulch",], seedlings_per_seed = seedlings_per_seed_sg, bin.num = testbins,  seedling_size = 0.5, surv_seedlings = surv_minis, seeds_per_flower = 150)

# Nope
sc_Bridgeport <- IPM_basic(df = size_scgl[size_scgl$Site ==  "Bridgeport",],seedlings_per_seed = seedlings_per_seed_sg, bin.num = testbins,  seedling_size = 0.5, surv_seedlings = surv_minis, seeds_per_flower = 150)

sc_OilPad <- IPM_basic(df = size_scgl[size_scgl$Site ==  "Oil Pad",], seedlings_per_seed = seedlings_per_seed_sg, bin.num = testbins,  seedling_size = 0.5, surv_seedlings = surv_minis, seeds_per_flower = 150)

# Works
sc_PyramidRock <- IPM_basic(df = size_scgl[size_scgl$Site ==  "Pyramid Rock",], seedlings_per_seed = seedlings_per_seed_sg, bin.num = testbins,  seedling_size = 0.5, surv_seedlings = surv_minis, seeds_per_flower = 150)
```
