...
# ScGl
seedlings_per_seed # not sure if this should be the 
testbins <- c(4,5,6,7,8) # I don't have enough individuals to get estimates if I break this into too many bins
df <- size_scgl
